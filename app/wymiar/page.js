...
export default function Wymiar(props) {
            ...
            <>
                {state.firstJob ?
                    ...
                    <div className="  flex items-center flex-col">
                        ...
                        {etat === 1
                            ?
                            <h1 className="text-5xl font-bold text-zielony-1 pt-1">
                                {` ${wyliczenie} ${state.wGodzinach ? "godzin" : "dni"}  urlopu `}
                            </h1>
    ...
    return (
        ...
        <div className=" flex    h-[calc(100vh_-_85px)] flex-col  w-full  p-4 md:p-8">
                        ...
                        <>
                            ...
                            <Disclosure.Panel>
                                <div className="flex w-full md:w-[90%]  flex-col       text-niebieski-10 pt-2  ">
                                    <div className="  flex w-full  text-niebieski-10  pt-8     ">
                                        <div className="flex flex-col  w-[20%] pr-6">
            ...
            <div className="w-full h-1/3   flex">
                ...
                <div className="w-[60%]  bg-niebieski-4 border border-niebieski-6 border-opacity-50 rounded-lg flex justify-center items-center mt-[2%]">
                ...
                <div className="w-[40%]  h-full flex justify-around items-center">
                    ...
                    {state.wymiar === 0 || state.wymiar === "" || error ?
                        ...
                        <div
                            ...
                            className="disabled  w-[40%] h-1/3     flex justify-center items-center  py-3   text-xl rounded-md font-bold   bg-szary-4  text-white   tracking-wider transition duration-300  "
                        >
                    ...
                    <button className={`outline-none absolute -bottom-2 -right-3 md:bottom-4  md:right-4 w-16 h-16   rounded-full flex justify-center items-center hover:bg-niebieski-10 bg-zielony-1 text-niebieski-6  hover:text-white hover:border    cursor-pointer tracking-wider transition duration-300  `} onClick={() => router.push('/wydruk')}>
