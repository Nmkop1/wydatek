...
function Page() {
  ...
  return (
    <>
      <div className='flex flex-col md:flex-row items-center justify-center  w-full h-[calc(100vh_-_85px)] p-6 md:p-32 bg-niebieski-7'>
        <div className='flex flex-col w-2/3 items-start'>
          ...
          <p className='text-white text-xl w-full md:w-[60%] pt-16 leading-9'>Pracuj zgodnie z przepisami, a my pomożemy Ci w tym wyliczając wydatek energetyczny i nie tylko.</p>
        </div>
        <div className='hidden w-1/3 md:flex items-center text-zielony-1'>        
          ...
          <h2 className="absolute bottom-2 right-3">1.0.1</h2>
        </div>
      </div>
